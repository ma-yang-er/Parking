...
<div class="wrap">
    <ul class="siderbar">
        ...
        <li><span>角色信息管理</span>
            <ul>
                ...
                <li><a href="<%=path %>/role/RoleAdd.jsp" target="mainFrame">添加角色信息</a></li>
                <li><a href="<%=path %>/RoleHandle?type=4" target="mainFrame">管理角色信息</a></li>
            </ul>
        </li>
        <li><span>用户信息管理</span>
            <ul>
                <li><a href="<%=path %>/user/UserAdd.jsp" target="mainFrame">添加用户信息</a></li>
                <li><a href="<%=path %>/UserHandle?type=4" target="mainFrame">管理用户信息</a></li>
            </ul>
        </li>
        <li><span>车位信息管理</span>
            <ul>
                <li><a href="<%=path %>/seat/SeatAdd.jsp" target="mainFrame">添加车位信息</a></li>
                <li><a href="<%=path %>/SeatHandle?type=4" target="mainFrame">管理车位信息</a></li>
            </ul>
        </li>
        <li><span>IC卡信息管理</span>
            <ul>
                <li><a href="<%=path %>/card/CardAdd.jsp" target="mainFrame">添加IC卡类型</a></li>
        ...
        <li><span>临时车辆停车管理</span>
            <ul>
                <li><a href="<%=path %>/temp/TempAdd.jsp" target="mainFrame">车主入场信息</a></li>
        ...
        <p>留言信息管理</p>
        <div>
            <a href="<%=path %>/Message/MessageAdd.jsp" target="mainFrame">添加留言信息</a>
            <br>
            <a href="<%=path %>/MessageHandle?type=4" target="mainFrame">管理留言信息</a>
        </div>
    ...
    <div class="content">
        <iframe width="100%" height="100%" name="mainFrame" frameborder="0" >
